...
/** Старт Google OAuth из Nexus IDE (VSCodium): не съедаем exchange в браузере. */
export default function IdeAuthBridgePage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        sessionStorage.setItem('nexus_oauth_for_desktop', '1');
