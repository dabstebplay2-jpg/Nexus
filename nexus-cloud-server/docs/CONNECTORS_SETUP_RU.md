...
Прод-пример cloud host: `https://nexus-cloud-ee17.onrender.com`
...
2. **Authorized redirect URIs:**  
   `https://nexus-cloud-ee17.onrender.com/v1/connectors/google_workspace/callback`
...
2. **Authorization callback URL:**  
   `https://nexus-cloud-ee17.onrender.com/v1/connectors/github/callback`
...
2. Redirect URI:  
   `https://nexus-cloud-ee17.onrender.com/v1/connectors/vercel/callback`
...
curl -s -H "Authorization: Bearer <JWT>" https://nexus-cloud-ee17.onrender.com/v1/connectors | jq '.oauth_status'
```
