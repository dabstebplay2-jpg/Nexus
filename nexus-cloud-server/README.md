...
| Прод (Render) | https://nexus-cloud-ee17.onrender.com |
...
```env
VITE_CLOUD_URL=https://nexus-cloud-ee17.onrender.com
```
...
Откройте **http://127.0.0.1:8790/local-admin/** — в поле **Server API** укажите Render (`https://nexus-cloud-ee17.onrender.com`), тот же пароль.
